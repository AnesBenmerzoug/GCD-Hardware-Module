...
gcd_testbench::gcd_testbench(sc_module_name name): sc_module(name){
  SC_HAS_PROCESS(gcd_testbench);
  SC_CTHREAD(do_testbench, clk.pos());
}

void gcd_testbench::do_testbench(){
